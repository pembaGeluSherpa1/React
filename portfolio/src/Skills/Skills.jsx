    ...
    return (
        ...
        <section class="skills container">
            ...
            <div class="grid-skills">
                ...
                <div class="grid-item">
                    <img src="https://portfolio-web-sand-kappa.vercel.app/images/javascript.svg
"  />
                    <h6>JavaScript</h6>
                </div>
                <div class="grid-item">
                ...
                <div class="grid-item">
                    <img src="https://portfolio-web-sand-kappa.vercel.app/images/bootstrap-solid%201.png
"  />
                    <h6>bootstrap</h6>
                </div>
                <div  class="grid-item">
